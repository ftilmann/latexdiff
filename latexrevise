...
###  die 'One of -a, -d or -s option required. Type latexrevise -h to get more help.';
###}
...
###  print STDERR "DEBUG: ",scalar @matches,"|||$body|||\n";
###  print STDERR "DEBUG: $ADDMARKCLOSE matches: ",scalar ($body =~ m/${ADDMARKCLOSE}/sg ),"\n";
  checkpure(@matches);
...
sub checkpure {
###  print STDERR "Checkpure : ",scalar(@matches)," tokens\n.";
