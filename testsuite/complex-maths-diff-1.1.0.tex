...
%DIF DEL complex-maths-old.tex   Thu Jun 12 00:01:26 2014
%DIF ADD complex-maths-new.tex   Thu Jun 12 00:01:26 2014
...
T_1$,
  ...
  \DIFdel{\int_0^{2\pi} V_\delta(g_t r_\theta x) d \theta
...
contradiction:
  ...
  \DIFdel{\tilde \alpha_i(\kappa(0))e^{(1+\delta+\epsilon)t_n |\kappa'(0)|_{\kappa(0)}}
...
\mbox{%DIFAUXCMD
\cite{eskin_masur} }%DIFAUXCMD
and Athreya \mbox{%DIFAUXCMD
\cite{athreya}}%DIFAUXCMD
.
}\begin{lem}
