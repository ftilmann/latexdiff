...
active for a very long time. %BEGIN DIFADD
It can also not explain the apparent
...
it. (c) Map of cluster locations used in  the shallow %BEGIN DIFADD
(light grey circles) %END DIFADD
and deep %BEGIN DIFADD
(dark grey circles)
%END DIFADD
stress inversions.}
\label{fig:focmec}
