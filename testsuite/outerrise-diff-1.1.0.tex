...
%DIF DEL outerrise-old.tex   Thu Jun 12 00:01:26 2014
%DIF ADD outerrise-new.tex   Thu Jun 12 00:01:26 2014
...
\citep{contreras-reyes07}}%DIFAUXCMD
.
...
\DIFaddbegin \DIFadd{\pagewiselinenumbers
}\DIFaddend % main text
...
\citep{ranero03}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{ranero03,ranero04,grevemeyer07}}%DIFAUXCMD
...
\item For the southern array only, we further restrict the data set to
  those events with a gap of less than 200\dg\DIFaddbegin \DIFadd{\ }\DIFaddend and eliminating outlier
  picks 
...
\citep{kurz04}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{spicak01}}%DIFAUXCMD
}\DIFaddend , in
...
\citet{ranero03} }%DIFAUXCMD
and
  \mbox{%DIFAUXCMD
\citet{peacock01} }%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{peacock01} }%DIFAUXCMD
and
  \mbox{%DIFAUXCMD
...
\citet{fisher03} }%DIFAUXCMD
had }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{fisher03_juandefuca} }%DIFAUXCMD
...
\citep{heesemann07abs}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep[see
Figure~\protect\ref{fig:epimaps}a for approximate location]{contreras-reyes07}}%DIFAUXCMD
}\DIFaddend . The
...
\citep[also see Figure~\ref{fig:overview-map}]{barrientos90}}%DIFAUXCMD
.  It is thus entirely
...
\citeauthor{mckenzie05}}%DIFAUXCMD
's
 \mbox{%DIFAUXCMD
\citeyearpar{mckenzie05} }%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdelend This is publication \DIFdelbegin \DIFdel{no }\DIFdelend GEOTECH-xxx of the \DIFaddbegin \DIFadd{R\&D programme }\DIFaddend GEOTECHNOLOGIEN program funded by
...
\citep{brune70} }%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{brune70} }%DIFAUXCMD
...
\DIFaddFL{Station }& \DIFaddFL{Lat }& \DIFaddFL{Lon         }& \DIFaddFL{Depth }& \DIFaddFL{\makebox[0cm][l]{Instrument$^{(1)}$} }& &\DIFaddFL{. }& \DIFaddFL{\makebox[0cm][r]{Statics (s)} }&  \DIFaddFL{Pobs }& \DIFaddFL{Sobs }& \DIFaddFL{$\log_{10}S_i$ }\\
      &   \dg \DIFaddFL{S  }& \dg \DIFaddFL{W    }& \DIFaddFL{(m)   }& \DIFaddFL{Hydr     }& \DIFaddFL{Seism            }& \DIFaddFL{P     }& \DIFaddFL{S     }& \DIFaddFL{\#   }& \DIFaddFL{\#   }&           \DIFaddFL{$^{(1)}$   }\\
\hline
