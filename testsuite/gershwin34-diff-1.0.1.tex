...
%DIF DEL gershwin34-old.tex   Sun Nov 11 23:13:10 2012
%DIF ADD gershwin34-new.tex   Sun Nov 11 23:13:08 2012
...
supplements is found at http://www.agu.org/pubs/esupp}\\\DIFadd{SUBSCRIPTNB}{\DIFadd{a}}\DIFadd{bout.html. 
}}\DIFaddend ).
...
\citet[Figures 5 and 6]{reston02}
}%DIFAUXCMD
...
\mbox{%DIFAUXCMD
\citep{toomey88,kong92,wolfe95,barclay01}
}%DIFAUXCMD
...
Oceanographer's Transform, 35\dg N, \citealp{cessaro86}}
}%DIFAUXCMD
...
a chance of 5}%DIFDELCMD < \% %%%
\DIFdel{for Q3, 2.5}%DIFDELCMD < \% %%%
\DIFdel{for Q2, 1.25}%DIFDELCMD < \% %%%
\DIFdel{for Q1 and 0.625}%DIFDELCMD < \% %%%
\DIFdel{for
...
and~\ref{fig:map95lon} show the 95}%DIFDELCMD < \% %%%
...
\DIFdelbeginFL %DIFDELCMD < \end{figure}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \end{plate*}
%DIF > \end{figure}
\DIFaddend 
