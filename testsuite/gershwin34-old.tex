...
%\documentclass[draft,jgr]{aguplus}
%\usepackage{times}
\bibliographystyle{agu}
\usepackage{mylatex}
% NO INCLUDE LABEL
\renewcommand{\includefig}[2]{}
% GRAPHICS uncomment the next two lines to include graphics
\usepackage{graphicx}
...
%TO RE-LOCATE THE EQS IN IT, AND I COULD EASILY CARRY THAT OUT.}
...
event rate then should be multiplied by a factor of 15--20 for a
direct comparison with OBS rates. Both rates are then compatible at
least by order of magnitude, with the possible exception of \citet{kong92}. }
...
intervals. Red lines indicate the position of refraction profiles
